...
},{}],"js/recharge.js":[function(require,module,exports) {
"use strict";
...
var recharge = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(code, secretKey, phoneNumber, Amount) {
    var allowCors, walletUrl, result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            allowCors = 'https://cors-anywhere.herokuapp.com/';
            walletUrl = "".concat(allowCors, "https://api.wallets.africa/bills/airtime/purchase");
            _context.next = 5;
          ...
          case 5:
            ...
            if (result.data.ResponseCode === '401') {
              (0, _alert.showAlert)('success', result.data.Message); // window.setTimeout(() => {
              //     location.assign('/');
              // }, 1500)
            }
  ...
  return function recharge(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();

exports.recharge = recharge;
},{"axios":"node_modules/axios/index.js","./alert":"js/alert.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
